# Generated by Django 5.1.2 on 2025-06-24 08:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year_level', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sms.yearlevel')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='teacher',
            name='year_levels',
            field=models.ManyToManyField(through='teacher.TeacherYearLevel', to='sms.yearlevel'),
        ),
    ]
