...
class Student(models.Model):
    ...
    classes = models.ManyToManyField(
        "sms.classPeriod", blank=False, related_name="Student"
    )
...
class StudentYearLevel(models.Model):
    ...
    level = models.ForeignKey("sms.YearLevel", on_delete=models.DO_NOTHING)
    year = models.ForeignKey("sms.SchoolYear", on_delete=models.DO_NOTHING)
